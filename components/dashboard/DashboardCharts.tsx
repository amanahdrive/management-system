  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bento-tile p-6 space-y-4">
          <div className="flex items-center justify-between">
            <div>
              <span className="eyebrow-label">Statistik Pertumbuhan</span>
              <h3 className="text-base font-brand font-bold text-[var(--text-primary)] flex items-center gap-2 mt-0.5">
          ...
          <div className="h-64">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={metrics.trenCashflow} margin={{ top: 10, right: 10, left: -10, bottom: 0 }}>
                ...
                <Line type="monotone" dataKey="pemasukan" stroke="#10B981" strokeWidth={2.5} dot={{ r: 3 }} name="Pemasukan" />
                <Line type="monotone" dataKey="pengeluaran" stroke="#F43F5E" strokeWidth={2.5} dot={{ r: 3 }} name="Pengeluaran" />
              </LineChart>
            </ResponsiveContainer>
          </div>
        </div>
