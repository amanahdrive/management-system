  ...
  const columns: ColumnDef<Paket>[] = [
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        if (isAllSelected) {
          return (
            <span className="inline-flex items-center px-2 py-0.5 rounded-md text-[10px] font-bold bg-emerald-500/10 text-emerald-700 dark:text-emerald-400 border border-emerald-500/20">
              Semua Opsi Mobil
            </span>
          );
        }
