...
export default function HomepageSubmissionsPage() {
  ...
  const getStatusBadge = (status: HomepageLeadStatus) => {
    switch (status) {
      ...
      case 'dihubungi':
        return (
          <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-md text-[11px] font-semibold bg-blue-500/10 text-blue-700 dark:text-blue-400 border border-blue-500/20">
      ...
      case 'siswa':
        return (
          <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-md text-[11px] font-semibold bg-emerald-500/10 text-emerald-700 dark:text-emerald-400 border border-emerald-500/20">
      ...
      case 'batal':
        return (
          <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-md text-[11px] font-semibold bg-zinc-500/10 text-zinc-600 border border-zinc-500/20">
            Batal
          </span>
        );
      default:
